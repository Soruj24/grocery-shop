...
export default function CategoryHero() {
  ...
  return (
    <section className="relative h-[400px] rounded-2xl overflow-hidden flex items-center justify-center text-center">
      ...
      <div className="relative z-20 space-y-8 px-6">
        <div className="w-24 h-24 bg-white/10 backdrop-blur-2xl rounded-2xl border border-white/20 flex items-center justify-center mx-auto animate-float shadow-2xl">
