            ...
            <div className="space-y-10">
              <div className="space-y-6">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary/10 border border-primary-border text-primary rounded-full text-xs font-black uppercase tracking-[0.2em]"
                >
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center gap-4 bg-white text-black px-8 py-4 rounded-2xl font-black transition-all shadow-sm hover:bg-primary hover:text-primary-foreground group"
                >
