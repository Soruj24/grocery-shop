...
export default function SubCategorySpotlight({
  ...
  return (
    <section className="relative overflow-hidden py-8 px-6">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-gradient-to-b from-primary/5 to-transparent blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-20">
        <div className="text-center space-y-6">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-tight">
            {t('subcategory_spotlight_title_1')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-hover">{t('subcategory_spotlight_title_2')}</span>
          </h2>
        </div>
