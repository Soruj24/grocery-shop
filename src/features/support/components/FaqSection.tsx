    ...
    <div className="mt-24 max-w-4xl mx-auto">
      ...
      <div className="space-y-4">
        {SUPPORT_FAQS.map((faq, index) => (
          <div key={index} className="bg-card rounded-2xl border border-border overflow-hidden shadow-sm">
            ...
            {openFaq === index && (
              <div className="px-8 pb-6 text-muted-foreground font-bold leading-relaxed border-t border-border pt-4">
                {faq.answer}
              </div>
            )}
          </div>
