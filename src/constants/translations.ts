...
export const translations = {
  bn: {
    ...
    empty_cart_desc: "আপনার কার্টে কোন পণ্য নেই। কেনাকাটা শুরু করুন।",
    empty_recently_viewed: "সম্প্রতি দেখা কোন পণ্য নেই",
    ai_search: "AI অনুসন্ধান",
    suggestions: "পরামর্শ",
    shop_by_category: "ক্যাটাগরি অনুযায়ী",
    close: "বন্ধ",
    theme: "থিম",
    dark: "ডার্ক",
    ...
    recently_viewed_title: "সম্প্রতি দেখা",
    clear_recent: "পরিষ্কার",
    view_all_notifications: "সব দেখুন",
    currency_label: "মুদ্রা",
    free_delivery_remaining: "ফ্রি ডেলিভারির জন্য আরও",
    free_delivery_unlocked: "ফ্রি ডেলিভারি আনলক হয়েছে!",

    // Homepage redesign keys
    brands: "ব্র্যান্ডসমূহ",
    brands_desc: "আমাদের পছন্দের বিশ্বস্ত ব্র্যান্ড",
    popular_collections: "জনপ্রিয় কালেকশন",
    popular_collections_desc: "সেরা পিক করা সংগ্রহ আপনার জন্য",
    todays_deals: "আজকের ডিল",
    todays_deals_desc: "প্রতিদিনের সেরা অফার এবং ছাড়",
    trending_now: "ট্রেন্ডিং এখন",
    best_sellers: "বেস্ট সেলার",
    recommended_for_you: "আপনার জন্য সুপারিশ",
    recommended_for_you_desc: "আপনার পছন্দ অনুযায়ী বাছাই করা",
    trust: "আমাদের কেন বিশ্বাস করবেন",
    trust_desc: "কেন হাজারো গ্রাহক আমাদের বেছে নেন",
    instagram: "ইনস্টাগ্রাম",
    instagram_desc: "আমাদের ইনস্টাগ্রামে সাথে থাকুন",
    follow_us: "আমাদের ফলো করুন",
    flash_sale: "ফ্ল্যাশ সেল",
    flash_sale_desc: "সীমিত সময়ের জন্য বিশাল ছাড়",
    deals_end_in: "ডিল শেষ হচ্ছে",
    shop_category: "ক্যাটাগরি দেখুন",
    explore_all: "সব দেখুন",
    sponsored_brands: "অংশীদার ব্র্যান্ড",
    view_all: "সব দেখুন",
    total_customers: "গ্রাহক",
    total_products: "পণ্য",
    ...
    guest_checkout_desc: "অ্যাকাউন্ট ছাড়াই অর্ডার করুন",
    login_to_checkout: "চেকআউটে লগইন করুন",
    or_continue_as_guest: "অথবা গেস্ট হিসেবে চালিয়ে যান",
    contact_information: "যোগাযোগের তথ্য",
    ship_to: "ডেলিভারি ঠিকানা",
    shipping_method: "শিপিং পদ্ধতি",
    standard_delivery: "স্ট্যান্ডার্ড ডেলিভারি",
    express_delivery: "এক্সপ্রেস ডেলিভারি",
    same_day_delivery: "একই দিনে ডেলিভারি",
    free_shipping_unlocked: "বিনামূল্যে শিপিং আনলক হয়েছে",
    ...
    use_custom_address: "কাস্টম ঠিকানা ব্যবহার করুন",
    enter_address_manually: "ঠিকানা ম্যানুয়ালি লিখুন",
    delivery_fee: "ডেলিভারি ফি",
    estimated_delivery: "আনুমানিক ডেলিভারি",
    secure_checkout: "নিরাপদ চেকআউট",
    secure_checkout_desc: "আপনার তথ্য সম্পূর্ণ নিরাপদ",
    ssl_encrypted: "SSL এনক্রিপ্টেড",
    money_back: "টাকা ফেরত",
    money_back_desc: "৭ দিনের মধ্যে টাকা ফেরত নিশ্চিত",
    verified_seller: "যাচাইকৃত বিক্রেতা",
    verified_seller_desc: "বিশ্বস্ত ও যাচাইকৃত",
    place_order: "অর্ডার দিন",
    placing_order: "অর্ডার দিচ্ছেন...",
    order_placed_successfully: "অর্ডার সফলভাবে দেওয়া হয়েছে",
    order_thank_you: "আপনার অর্ডারের জন্য ধন্যবাদ",
    order_confirmation_sent: "অর্ডার নিশ্চিতকরণ পাঠানো হয়েছে",
    order_track_your: "আপনার অর্ডার ট্র্যাক করুন",
    step_information: "তথ্য",
    step_delivery: "ডেলিভারি",
    step_payment: "পেমেন্ট",
    step_review: "পর্যালোচনা",
    name_required: "নাম আবশ্যক",
    phone_required: "ফোন নম্বর আবশ্যক",
    phone_min_11: "ফোন নম্বর কমপক্ষে ১১ ডিজিট হতে হবে",
    address_required: "ঠিকানা আবশ্যক",
    email_optional: "ইমেইল (ঐচ্ছিক)",
    email_invalid: "সঠিক ইমেইল দিন",
    transaction_id_required: "ট্রানজেকশন আইডি আবশ্যক",
    transaction_id_min: "ট্রানজেকশন আইডি কমপক্ষে ৮ অক্ষর হতে হবে",
    confirm_order_question: "অর্ডার নিশ্চিত করবেন?",
    confirm_order_desc: "এই অর্ডারটি দেওয়া হবে",
    yes_confirm: "হ্যাঁ, নিশ্চিত করুন",
    same_as_above: "উপরের মতোই",
    select_shipping: "শিপিং পদ্ধতি নির্বাচন করুন",
    select_payment: "পেমেন্ট পদ্ধতি নির্বাচন করুন",
    select_time_slot: "সময় স্লট নির্বাচন করুন",
    price_free: "বিনামূল্যে",
    includes_vat: "ভ্যাট অন্তর্ভুক্ত",
    back_to_cart: "কার্টে ফিরে যান",
    continue_to_shipping: "শিপিংয়ে এগিয়ে যান",
    continue_to_payment: "পেমেন্টে এগিয়ে যান",
    continue_to_review: "পর্যালোচনায় এগিয়ে যান",

    // Cart Enhancement
    empty_cart_message: "আপনার কার্টে কোনো পণ্য নেই। কেনাকাটা শুরু করুন।",
    order_summary_title: "অর্ডার সামারি",
    estimated_delivery_date: "আনুমানিক ডেলিভারি",
    free_shipping_achieved: "বিনামূল্যে শিপিং আনলক হয়েছে!",
    add_for_free_shipping: "ফ্রি ডেলিভারির জন্য আরও কেনাকাটা করুন",
    login_to_checkout_button: "চেকআউটে লগইন করুন",
    guarantee_title: "সন্তুষ্টির গ্যারান্টি",
    guarantee_description: "১০০% সন্তুষ্টির গ্যারান্টি। পণ্য না পেলে টাকা ফেরত।",
    please_enter_coupon_code: "কুপন কোড দিন",
    have_coupon_code: "কুপন কোড আছে?",
    coupon_code_placeholder_input: "কুপন কোড লিখুন",
    apply_button: "অ্যাপ্লাই",
    service_charge: "সার্ভিস চার্জ",
    tax_included: "ভ্যাট অন্তর্ভুক্ত",
    saved_for_later_title: "পরের জন্য সংরক্ষিত",
    items_saved_count_suffix: "টি সংরক্ষিত",
    move_to_cart_button: "কার্টে নিন",
    wishlist_button: "উইশলিস্ট",
    you_may_also_like: "আপনি আরও পছন্দ করতে পারেন",
    failed_to_add_to_cart: "কার্টে যোগ করা যায়নি",
    free_label: "ফ্রি",
    contact_and_address: "যোগাযোগ ও ঠিকানা",
    shipping_and_delivery: "শিপিং ও ডেলিভারি",
    payment_method_label: "পেমেন্ট পদ্ধতি",
    order_items: "অর্ডারের আইটেম",
    order_total: "অর্ডারের মোট",
    ready_to_order: "অর্ডার দিতে প্রস্তুত?",
    click_below_to_confirm: "নিশ্চিত করতে নিচের বোতামে ক্লিক করুন",
    select_shipping_title: "শিপিং পদ্ধতি নির্বাচন করুন",
    choose_delivery_speed: "আপনার ডেলিভারি গতি বাছাই করুন",
    select_time_window: "একটি সময় স্লট বাছাই করুন",
    select_payment_title: "পেমেন্ট পদ্ধতি নির্বাচন করুন",
    choose_how_to_pay: "কীভাবে পেমেন্ট করতে চান তা বাছাই করুন",
    enter_transaction_id: "লেনদেন আইডি প্রবেশ করুন",
    after_payment_enter_ref: "পেমেন্ট করার পর রেফারেন্স নম্বর নিচে লিখুন",
    where_should_we_deliver: "কোথায় ডেলিভারি করব?",
  },
};