              ...
              <div className="flex items-center gap-3">
                {[
                  ...
                  <div key={i} className="flex items-end gap-2">
                    <div className="bg-gray-900 dark:bg-white text-white dark:text-black rounded-2xl w-16 h-16 flex items-center justify-center text-3xl font-black tabular-nums shadow-xl shadow-gray-900/20 dark:shadow-white/10 border border-gray-800 dark:border-gray-100">
                      {t.value.toString().padStart(2, '0')}
                    </div>
                    <span className="text-[10px] font-black text-gray-400 mb-2 uppercase tracking-wider">{t.label}</span>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-400 line-through font-bold">
                        {t('currency_symbol')}{Math.round(product.price * 1.25).toLocaleString(language === 'bn' ? 'bn-BD' : 'en-US')}
                      </span>
                    </div>
                  </div>
                </div>
