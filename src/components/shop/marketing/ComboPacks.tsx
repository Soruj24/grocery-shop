                  ...
                  <div className="relative aspect-square">
                    ...
                    <div className="absolute inset-4 grid grid-cols-2 gap-2 group-hover:rotate-3 transition-transform duration-500 ease-in-out">
                      {combo.items.slice(0, 4).map((item, i) => (
                        <div
                          key={i}
                          className="relative bg-white dark:bg-gray-800 rounded-2xl p-2 shadow-sm overflow-hidden border border-gray-100 dark:border-white/5 group-hover:scale-105 transition-transform duration-500 delay-[50ms]"
                        >
                          <Image
                  ...
                  <div className="flex-1 space-y-3 mb-8">
                    ...
                    {combo.items.length > 3 && (
                      <div className="text-xs font-bold text-gray-400 pl-6 text-left">
                        + {(combo.items.length - 3).toLocaleString("bn-BD")}{" "}
                        more items...
                      </div>
                    )}
                  </div>
                    ...
                    <div className="flex items-end justify-between md:justify-start gap-4 mb-4">
                      <div className="flex flex-col items-start">
                        <span className="text-xs font-bold text-gray-400 line-through">
                          {t("currency_symbol")}
                          {(combo.price + combo.saveAmount).toLocaleString(
                            "bn-BD",
                          )}
                        </span>
