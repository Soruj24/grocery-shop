      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center text-[11px] font-black uppercase tracking-[0.2em]">
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-3 group cursor-default">
            ...
            <span className="text-green-50/90 dark:text-gray-400">{t('fresh_organic')}</span>
          </div>
          <div className="flex items-center gap-3 group cursor-pointer hover:text-green-300 transition-colors">
            <PhoneCall className="w-3.5 h-3.5" />
            <span className="text-green-50/90 dark:text-gray-400">{t('helpline')}: {t('helpline_number')}</span>
          </div>
        </div>
        <div className="flex items-center gap-8">
          <Link href="/track" className="hover:text-green-300 transition-colors flex items-center gap-2">
            {t('track_order')}
          </Link>
