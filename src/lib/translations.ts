export const translations = {
  bn: {
    ...
    out_of_stock_label: "আউট অফ স্টক",
    default_unit: "১ কেজি",
    unit_kg: "কেজি",
    unit_g: "গ্রাম",
    ...
    popular_search_1: "তাজা ফল",
    popular_search_2: "অর্গানিক সবজি",
    popular_search_3: "গরুর মাংস",
    popular_search_4: "দুধ",
    popular_search_5: "চিনিগুড়া চাল",
    categories_title: "সব ক্যাটাগরি",
  ...
  en: {
    ...
    cart_empty_desc:
      "Looks like you haven't chosen anything yet. You can see our best offers.",
    ...
    order_success_title: "Order Successful!",
    order_success_desc:
      "Your order has been received. Our representative will contact you soon.",
    view_my_orders: "View My Orders",
    continue_shopping: "Continue Shopping",
    ...
    popular_search_3: "Local Chicken",
    ...
    popular_searches_title: "Popular Searches",
    popular_search_1: "Fresh Fruits",
    popular_search_2: "Organic Vegetables",
    popular_search_3: "Beef",
    popular_search_4: "Milk",
    popular_search_5: "Chinigura Rice",
    categories_title: "All Categories",
