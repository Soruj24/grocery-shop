...
export default function SupportPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="relative rounded-[48px] overflow-hidden mb-16 min-h-[400px] flex items-center justify-center text-center">
        <Image 
          src={getProductFallbackImage("support")} 
        ...
        <div className="relative z-10 space-y-6 max-w-3xl px-6 py-12">
          <motion.div
            ...
            className="w-20 h-20 bg-green-600 rounded-2xl flex items-center justify-center mx-auto shadow-2xl shadow-green-600/30 mb-6"
          >
          ...
          >
            আমরা কিভাবে <span className="text-green-400">আপনাকে সাহায্য</span> করতে পারি?
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            className="text-gray-200 font-medium text-lg md:text-xl max-w-2xl mx-auto leading-relaxed"
          >
