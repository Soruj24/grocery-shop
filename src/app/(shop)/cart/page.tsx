    ...
    <div className="max-w-7xl mx-auto py-12 px-4 space-y-12 relative">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <h1 className="text-5xl font-black text-gray-900 dark:text-white tracking-tight">আপনার শপিং ব্যাগ</h1>
          <p className="text-gray-500 dark:text-gray-400 font-bold text-lg">
            মোট {cart.length}টি পণ্য আপনার ব্যাগে আছে
          </p>
        </div>
        <Link 
          href="/products"
        ...
        >
          বাজার চালিয়ে যান <ArrowRight className="w-5 h-5" />
        </Link>
      </div>
